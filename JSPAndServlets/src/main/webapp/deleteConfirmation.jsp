...
<head>
	...
	<link rel="stylesheet" href="css/deleteConfirmation.css" type="text/css">
	<link rel="stylesheet"
...
<body>
	...
	<div
		style="width: 50%; height: 90%; border: 1px beige #dee2e6; margin: auto; border-style: groove;"
		class="border border-secondary" id="loading">
		...
		<div style="margin-bottom: 20px">
			<a style="text-decoration: none; margin-left: 30%"
				href="deleteServlet?user=<%=request.getAttribute("user")%>">
				<button class="btn btn-danger">Delete</button>
			</a> <a style="margin-left: 24%; text-decoration: none"
				" href="showAllRecords">
