					...
					<div class="form-group row" id="id">
						...
						<div class="col-sm-7">
							<input type="text" name="id" class="form-control" id="id"
								...
								value="<c:out value='${editedRow.id}' default='${employeeRecords.id}'/>"
				...
				<div class="form-group row" id="fname">
					...
					<div class="col-sm-7">
						<input type="text" name="firstname" class="form-control"
							...
							value="<c:out value='${editedRow.firstName}' default='${employeeRecords.firstName}'/>">
				...
				<div class="form-group row" id="lname">
					...
					<div class="col-sm-7">
						<input type="text" name="lastname" id="lastname"
							...
							value="<c:out value='${editedRow.lastName}' default='${employeeRecords.lastName}'/>">
				...
				<div class="form-group row" id="uname">
					...
					<div class="col-sm-7">
						<input type="text" name="username" class="form-control"
							...
							value="<c:out value='${editedRow.user}' default='${employeeRecords.user}'/>">
				...
				<div class="form-group row" id="pass">
					...
					<div class="col-sm-7">
						<input type="password" name="password" pattern="[A-Za-z,0-9]{1,32}"
							...
							value="<c:out value='${editedRow.pass}' default='${employeeRecords.pass}'/>">
						<span class="formError"></span>
					</div>
				</div>
				...
				<div class="form-group row" id="add">
					...
					<div class="col-sm-7">
						<input type="text" name="address" class="form-control"
							...
							value="<c:out value='${editedRow.address}' default='${employeeRecords.address}'/>">
						<span class="formError"></span>
					</div>
				</div>
				...
				<div class="form-group row" id="email">
					...
					<div class="col-sm-7">
						<input type="text" name="emailId" class="form-control"
							...
							value="<c:out value='${editedRow.emailId}' default='${employeeRecords.emailId}'/>">
				...
				<div class="form-group row" id="contact">
					...
					<div class="col-sm-7">
						<input type="text" name="contact" class="form-control"
							...
							placeholder="Enter contact number" maxlength="11" onkeypress="checkContactDuplicate()" onblur="checkContactDuplicate()"
							value="<c:out value='${editedRow.contact}' default='${employeeRecords.contact}'/>">
