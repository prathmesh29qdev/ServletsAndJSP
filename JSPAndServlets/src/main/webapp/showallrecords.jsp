...
<html>
	...
	<body>
		...
		<div id="myDiv" style="display: none; width: 50%; height: 90%; border: 1px beige #dee2e6; margin-top: 2%; margin-left: 25%; border-style: groove;"
			class="border border-secondary">
			<div style="margin-bottom: 20px">
				<form action="deleteservlet" method="post" style="float: left; margin-left: 242px">
					<div>
						<h4 style="margin-left: -21px; margin-top:19px; margin-bottom: 32px">
				...
				<a style="margin-left: 24%; text-decoration: none" href="showallrecords">
					<button class="btn btn-secondary" style="width: 56%; margin-left: -29px">Cancel</button>
				</a>
			</div>
		</div>
