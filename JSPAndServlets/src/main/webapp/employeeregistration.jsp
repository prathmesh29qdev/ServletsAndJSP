	...
	<body style="height: fit-content; background-repeat: no-repeat; background-size: cover; background-image: url('images/image.jpg')">
		<div style="width: 100%; display: flex; margin-top: 8%">
			<div class="card-body" style="margin-left: 0px; background-color: white; margin-left: 23%; margin-right: 23%; border-radius: 3%">
				...
				<div>
					<c:if test="${recordToBeEdited != null}">
						<form action="register" method="post" name="myForm" class="classform" onsubmit="return validateForm()" style="margin-left: 11%">
					</c:if>
					<c:if test="${recordToBeEdited == null}">
						<form method="post" action="register" name="myForm" class="classform" onsubmit="return validateForm()" style="margin-left: 11%">
					</c:if>
						...
						<div class="form-group row" id="id">
							...
							<div class="col-sm-7">
								<input type="text" name="id" class="form-control" id="id"
									name="id" autocomplete="off" placeholder="Enter first name"
									maxlength="15"
					...
					<div class="form-group row" id="uname">
						...
						<div class="col-sm-7">
							<input type="text" name="username" class="form-control"
								...
								onkeypress="checkUserNameDuplicate()"
								onblur="checkUserNameDuplicate()" placeholder="Enter username"
					...
					<div class="form-group row" id="email">
						...
						<div class="col-sm-7">
							<input type="text" name="emailId" class="form-control"
								...
								onkeypress="checkForDuplicate()" onblur="checkForDuplicate()"
					...
					<div class="form-group row" id="contact">
						...
						<div class="col-sm-7">
							<input type="text" name="contact" class="form-control"
								autocomplete="off" id="contactt"
								onkeyup="return validateContact()"
								placeholder="Enter contact number" maxlength="10"
								onkeypress="checkContactDuplicate()"
								onblur="checkContactDuplicate()"
					...
					<c:if test="${recordToBeEdited != null}">
						<button type="submit" class="btn btn-outline-primary" style="width: 43%; margin-left: 178px; margin-top: 22px">
							Update</button>
					</c:if>
					<c:if test="${recordToBeEdited == null}">
						<button type="submit" class="btn btn-outline-primary" style="width: 43%; margin-left: 178px; margin-top: 22px">
					...
					<form action="showallrecords" method="get" style="margin-top: 10px;">
						<button type="submit" class="btn btn-outline-dark" style="margin-left: 275px; width: 40%; background-color: transparent; color: black">Show
							All Records</button>
					</form>
				</div>
			</div>
