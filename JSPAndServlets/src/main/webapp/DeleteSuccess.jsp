...
<body
	style="height: fit-content; background-repeat: no-repeat; background-size: cover; background-image: url('images/image.jpg')">
	<div class="card-body"
		...
		<div style="padding-top: 10%;">
			<h2 class="successmessage"
				style="border: green 3px solid; padding: 62px 318px">
		...
		<form action="showAllRecords" method="get" style="margin-top: 10px;">
			<button type="submit" class="btn btn-outline-primary"
				style="margin-left: 440px; width: 40%; background-color: transparent; color: black">Show
				All Records</button>
		</form>
	</div>
</body>
