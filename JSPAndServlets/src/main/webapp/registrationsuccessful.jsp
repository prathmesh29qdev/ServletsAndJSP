	...
	<body style="height: fit-content; background-repeat: no-repeat; background-size: cover; background-image: url('images/image.jpg')">
		<div class="card-body" style="background-color: white; margin-left: 9%; margin-right: 9%; border-radius: 2%; width: 82%; margin-top: 9%">
			...
			<div class="tabcontainer">
				<table style="" class="successtable">
					...
					<tr>
						...
						<td class="dash">-</td>
						<td class="values"><%=request.getParameter("emailId")%></td>
					</tr>
					<tr>
			...
			<form action="showallrecords" method="get" style="margin-top: 10px;">
				<button type="submit" class="btn btn-outline-primary" style="margin-left: 429px; width: 40%; background-color: transparent; color: black">Show
					All Records</button>
			</form>
		</div>
	</body>	
